...
public class RPGEnchantmentScreenHandler extends ScreenHandler {
	...
	public RPGEnchantmentScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
		...
		this.addSlot(new Slot(this.inventory, 1, 35, 47) {
			...
			public Pair<Identifier, Identifier> getBackgroundSprite() {
				return Pair.of(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE, RPGEnchantmentScreenHandler.EMPTY_LAPIS_SLOT_TEXTURE);
			}
		});
