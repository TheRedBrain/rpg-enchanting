...
public class ScreenHandlerTypesRegistry {
	public static final ExtendedMenuType<RPGEnchantmentScreenHandler, RPGEnchantmentScreenHandler.RPGEnchanterBlockData> RPG_ENCHANTMENT_SCREEN_HANDLER = new ExtendedMenuType<>(RPGEnchantmentScreenHandler::new, RPGEnchantmentScreenHandler.RPGEnchanterBlockData.PACKET_CODEC);
